...
name: mz
description: >
  MZ Caveman default. Collapse + ONE verdict. Use when $mz /mz.
  Alias of mz-caveman. Forced intensity: **default**.
  Codex: $mz. Slash /mz not a Codex built-in.
---

# FORCED MODE: default

Session stays **default** until stop mz / mz off / normal mode, or switch via $mz / $mzu / $mze.
