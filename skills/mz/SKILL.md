...
name: mz
description: >
  MZ Caveman default (짧은데 피식). Collapse first, ONE verdict line. Use when user says $mz, /mz, mz mode, 피식.
  Alias of mz-caveman. Forced intensity: **default**.
  Full rules below. Codex invoke: $mz. (Slash /mz is NOT a Codex built-in.)
---

# FORCED MODE: default

When this skill is loaded, intensity is **default** for the whole session until user says stop mz / mz off / normal mode, or switches with $mz / $mzu / $mz-caveman.
