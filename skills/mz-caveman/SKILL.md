...
name: mz-caveman
description: >
  Short-and-chuckle agent prose with intensity levels. Default /mz: collapse first,
  ONE meme-like verdict line. /mzu or /mz ultra: max MZ slang spam, comedy-chaos,
  barely usable for real work. Core 40 seasoning vs 난사. Use when user says /mz,
  /mzu, /mz ultra, /mz-caveman, mz-caveman, MZ 케이브맨, or wants 피식 / 난사 mode.
---
